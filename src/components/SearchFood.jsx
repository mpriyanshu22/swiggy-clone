          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {filteredItems.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white p-4 rounded-2xl shadow-md flex flex-col items-center justify-between gap-6"
                >
                  {/* Left content */}
                  ...
                  <div className="relative flex-1 w-full flex justify-center">
                    ...
                    <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2">
                      {cartItem ? (
                        <div className="flex items-center bg-white border border-green-500 text-green-600 font-medium px-4 py-1 rounded-full shadow-sm h-10 w-35 justify-around">
                          <button
                        ...
                        <button
                          ...
                          className="bg-white border border-green-500 text-green-600 font-medium px-5 py-1 rounded-full shadow hover:bg-green-50 transition-all h-10 w-35"
                        >
                          Add to Cart
                        </button>
                      )}
